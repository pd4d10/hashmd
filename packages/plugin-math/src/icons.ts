...
export const icons = {
  ...
  block:
    '<svg width="1em" height="1em" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M36 11l-3-3H12l16 16-16 16h21l3-3M6 5v38M42 5v38" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/></svg>',
};

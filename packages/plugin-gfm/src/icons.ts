...
export const icons = {
  ...
  task:
    '<svg width="1em" height="1em" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#icon-732311e097271bd)" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"><path d="M42 20v19a3 3 0 01-3 3H9a3 3 0 01-3-3V9a3 3 0 013-3h21"/><path d="M16 20l10 8L41 7"/></g><defs><clipPath id="icon-732311e097271bd"><path fill="currentColor" d="M0 0h48v48H0z"/></clipPath></defs></svg>',
  table:
